...
@torch.no_grad()
def main():
    parser = argparse.ArgumentParser(description="Evaluate a trained Flow Matching model")
    ...
    model_class = {
        "unet_small": UNetSmall, "unet_xsmall": UNetXSmall, "unet_xxsmall": UNetXXSmall,
    }.get(ckpt.get("model_name", "unet"), UNet)
